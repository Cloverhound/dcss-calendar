...
export const handleToggleForceClosedClicked      = obj => ({ type: "HANDLE_TOGGLE_FORCE_CLOSED_CLICKED", payload: obj });
export const handleToggleOptionalPromptsClicked      = obj => ({ type: "HANDLE_TOGGLE_OPTIONAL_PROMPTS_CLICKED", payload: obj });
export const handleToggleOptionalPromptsCancel  = ()  => ({type: "HANDLE_TOGGLE_OPTIONAL_PROMPTS_CANCEL"})
export const handleToggleQueueForceClosedCancel  = ()  => ({type: "HANDLE_TOGGLE_QUEUE_FORCE_CLOSED_CANCEL"})
export const submitQueueForceCloseToggle  = (obj)  => ({type: "SUBMIT_QUEUE_FORCE_CLOSE_TOGGLE", payload: obj})
...
export const handleToggleLcsaBcpActiveCancel = () => ({type: "HANDLE_TOGGLE_LCSA_BCP_ACTIVE_CANCEL"});
