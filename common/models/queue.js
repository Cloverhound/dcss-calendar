  ...
  if(force_closed) {
    ...
    if(schedule) {
      ...
      if(singleDateTimeRangesTodayArray.length) {
        return checkSingleDateTimeRanges(singleDateTimeRangesTodayArray, ewt, lcsa_name, lcsa_id, lcsa_status, force_closed)
      }
...
const checkSingleDateTimeRanges = (singleDateTimeRanges, ewt, lcsa_name, lcsa_id, lcsa_status, force_closed) => {
